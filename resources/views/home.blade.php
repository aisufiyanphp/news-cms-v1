    ...
    <div class="container">
        <div class="row m-rl--1">
            <div class="col-md-6 p-rl-1 p-b-2">
                <div class="bg-img1 size-a-3 how1 pos-relative" style="background-image: url('{{asset('front-assets/images/post-01.jpg')}}');">
            ...
            <div class="col-md-6 p-rl-1">
                <div class="row m-rl--1">
                    <div class="col-12 p-rl-1 p-b-2">
                        <div class="bg-img1 size-a-4 how1 pos-relative" style="background-image: url('{{asset('front-assets/images/post-02.jpg')}}');">
                            <a href="blog-detail-01.html" class="dis-block how1-child1 trans-03"></a>
                    ...
                    <div class="col-sm-6 p-rl-1 p-b-2">
                        <div class="bg-img1 size-a-5 how1 pos-relative" style="background-image: url('{{asset('front-assets/images/post-03.jpg')}}');">
                            <a href="blog-detail-01.html" class="dis-block how1-child1 trans-03"></a>
                    ...
                    <div class="col-sm-6 p-rl-1 p-b-2">
                        <div class="bg-img1 size-a-5 how1 pos-relative" style="background-image: url('{{asset('front-assets/images/post-04.jpg')}}');">
                            <a href="blog-detail-01.html" class="dis-block how1-child1 trans-03"></a>
                            ...
                            <div class="tab-pane fade" id="tab1-2" role="tabpanel">
                                <div class="row">
                                    <div class="col-sm-6 p-r-25 p-r-15-sr991">
                                        ...
                                        <div class="m-b-30">
                                            <a href="blog-detail-01.html" class="wrap-pic-w hov1 trans-03">
                                                <img src="{{asset('front-assets/images/post-09.jpg')}}" alt="IMG">
                                            </a>
...
<div class="container">
    ...
    <div class="flex-c-c">
        <a href="#">
            <img class="max-w-full" src="{{asset('front-assets/images/banner-01.jpg')}}" alt="IMG">
        </a>
    </div>
</div>
